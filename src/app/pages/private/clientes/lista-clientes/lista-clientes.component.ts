...
export class ListaClientesComponent implements OnInit, OnDestroy {
    ...
    editItem(item: Cliente) {
        ...
        item.codigoCliente=="99003"){
            this.mensajeService.showWarning('No puede modificar clientes con código especial');
            return;
        }*/
    ...
    deleteItem(item: Cliente) {
        ...
        item.codigoCliente=="99002" ||
        item.codigoCliente=="99003"){
            this.mensajeService.showWarning('No puede eliminar clientes con código especial');
            return;
        }
